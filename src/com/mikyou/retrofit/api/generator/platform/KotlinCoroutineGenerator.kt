...
class KotlinCoroutineGenerator : IGenerator {
    ...
    companion object {
        ...
        private const val PATH_TEMPLATE_API: String = "/template/api/api_kotlin_coroutine.vm"
        private const val PATH_TEMPLATE_INTERFACE_API: String = "/template/api/api_interface_kotlin_coroutine.vm"
    }
}